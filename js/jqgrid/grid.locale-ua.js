...
$.extend($.jgrid,{
    ...
    Find: "Знайти",
    Reset: "Скидання",
    odata : ['дорівнює', 'не дорівнює', 'менше', 'менше або рівне','більше','більше або рівне', 'починається з','не починається з','знаходиться в','не знаходиться в','закінчується на','не закінчується на','містить','не містить'],
