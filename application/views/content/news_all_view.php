...
<div class="title">
 <h1>
  <a href="<?=base_url();?>news/<?=$n['news_id'];?>" title="Читати повністю"><?=$n['title_news'];?></a>
 </h1>
</div>
<div class="inf">
  ...
  <a href="<?=base_url();?>news/<?=$n['news_id'];?>">
   <img class="small" src="<?=base_url();?><?=$n['small_img'];?>" width="450" height="190" alt="mini_img" title="Читати повністю" />
  </a>
 <div class="clear"></div>
<div>
